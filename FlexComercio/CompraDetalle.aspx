        ...
        <div class="col-md-10 col-lg-9">
            ...
            <div class="card p-4 border-0 shadow-sm">
                        ...
                        <dl class="row mb-0">
                            ...
                            <dd class="col-sm-8">
                                <asp:Label ID="lblTotal"
                                    runat="server"
                                    CssClass="form-control-plaintext fw-bold text-success" />
                            </dd>
                ...
                <asp:GridView ID="dgvDetalleCompra"
                    ...
                    EmptyDataText="No se encontraron productos para esta compra.">
