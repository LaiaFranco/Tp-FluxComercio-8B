        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-3 col-12 text-md-end text-start p-3">
                        <a href="ViewVentasDetalle.aspx?id=<%= venta.Id %>" class="btn btn-outline-primary btn-sm rounded-pill me-1">
                            <i class="bi bi-eye"></i> Ver
                        </a>
                        <a href="EditarVenta.aspx?id=<%= venta.Id %>" class="btn btn-outline-warning btn-sm rounded-pill">
